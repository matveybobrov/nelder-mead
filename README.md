...
- Зайдите в свой репозиторий, нажмите на кнопку "Code" и скопируйте https адрес
...
- Результат работы алгоритма должен возвращать следующего вида:
```javascript
{
  // Решение алгоритма
  Solution: {X: 0, Y: 0},
...
git push
```
Затем создайте pull request в свою ветку
